...
function cpt_podcast() {
	...
	register_post_type( 'podcast', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			'name' => __('Podcasts', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Podcast', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Podcasts', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Podcast', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Podcast', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Podcast', 'jointswp'), /* New Display Title */
			'view_item' => __('View Podcast', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Podcasts', 'jointswp'), /* Search Custom Type Title */
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'This is a podcast custom post type.', 'jointswp' ), /* Custom Type Description */
			'public' => true,
			...
			'has_archive' => 'podcasts', /* you can rename the slug here */
